...
static struct s_ivec ***alloc_and_load_track_to_pin_lookup(INP int
							   ****pin_to_track_map,
							   INP int Fc,
							   INP int height,
							   INP int num_pins,
...
static t_seg_details *alloc_and_load_global_route_seg_details(INP int
							      nodes_per_chan,
							      INP int
							      global_route_switch);
...
static void
load_uniform_switch_pattern(INP t_type_ptr type,
			    INOUTP int ****tracks_connected_to_pin,
			    INP int num_phys_pins,
			    INP int *pin_num_ordering,
			    INP int *side_ordering,
...
static void
load_perturbed_switch_pattern(INP t_type_ptr type,
			      INOUTP int ****tracks_connected_to_pin,
			      INP int num_phys_pins,
			      INP int *pin_num_ordering,
			      INP int *side_ordering,
...
alloc_and_load_track_to_pin_lookup(INP int ****pin_to_track_map,
				   INP int Fc,
				   INP int height,
				   INP int num_pins,
				   INP int nodes_per_chan)
 ...
 * only for debugging.                                                    */
void
dump_rr_graph(INP const char *file_name)
{
